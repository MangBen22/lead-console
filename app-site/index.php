        ...
        <main class="content">
            ...
            <section class="api-status">
                ...
                <form id="crmSmtpFilterForm" class="inline-form">
                    ...
                    <button id="downloadCrmSmtpExportBtn" type="button">Download SMTP Export</button>
                </form>
                <pre id="crmSmtpSummary">Loading...</pre>
                <form id="crmSmtpDetailForm" class="inline-form">
                    <div class="form-row">
                        <label for="crmSmtpDetailSiteId">Detail Site ID</label>
                        <input id="crmSmtpDetailSiteId" type="text" placeholder="hq-main">
                    </div>
                    <div class="form-row">
                        <label for="crmSmtpDetailLimit">Watch Run Limit</label>
                        <input id="crmSmtpDetailLimit" type="number" min="1" max="50" value="10">
                    </div>
                    <button id="loadCrmSmtpDetailBtn" type="button">Load SMTP Detail</button>
                </form>
                <pre id="crmSmtpDetail">No SMTP detail loaded.</pre>
            ...
            <section class="api-status">
                ...
                <pre id="crmOperationsIssuesSummary">Loading...</pre>
            </section>
            ...
            <section class="api-status">
                ...
                <pre id="socialOpsHistorySummaryView">Loading...</pre>
                <pre id="socialOpsLatestCompareView">Loading...</pre>
                <pre id="socialOpsIssuesSummaryView">Loading...</pre>
            </section>
            ...
            <section class="api-status">
                ...
                <pre id="webopsOperationsHistorySummaryView">Loading...</pre>
                <pre id="webopsOperationsIssuesSummaryView">Loading...</pre>
            </section>
            ...
            <section class="api-status">
                ...
                <div class="actions">
                    ...
                    <button id="downloadSeoIssuesExportBtn" type="button">Download SEO Issues</button>
            ...
            <section class="api-status">
                ...
                <div class="actions">
                    ...
                    <button id="downloadSeoProjectSnapshotExportBtn" type="button">Download Snapshot</button>
                    ...
                    <button id="downloadSeoOpportunitiesExportBtn" type="button">Download Opportunities</button>
            ...
            <section class="api-status">
                ...
                <pre id="seoOperationsHistorySummaryView">Loading...</pre>
                <pre id="seoOperationsIssuesSummaryView">Loading...</pre>
            </section>
            ...
            <section class="api-status">
                ...
                <form id="launchOperationsSnapshotForm" class="inline-form">
                    ...
                    <button id="downloadLaunchOperationsHistorySummaryBtn" type="button">Download Launch History Summary</button>
                    <button id="downloadLaunchOperationsSourceSummaryBtn" type="button">Download Launch Source Summary</button>
                    ...
                    <button id="downloadLaunchOperationsReviewBundleBtn" type="button">Download Launch Review Bundle</button>
                </form>
                <pre id="launchOperationsSnapshotView">Loading...</pre>
                <pre id="launchOperationsHistoryView">Loading...</pre>
                <form id="launchOperationsHistoryDetailForm" class="inline-form">
                    <div class="form-row">
                        <label for="launchOperationsHistoryDetailId">History Snapshot ID</label>
                        <input id="launchOperationsHistoryDetailId" type="text" placeholder="launch_ops_YYYYMMDD_HHMMSS_xxxxxx">
                    </div>
                    <button id="loadLaunchOperationsHistoryDetailBtn" type="button">Load Launch History Detail</button>
            ...
            <section class="api-status">
                ...
                <div class="actions">
                    ...
                    <button id="downloadReleaseDecisionBtn" type="button">Download Release Decision</button>
                </div>
                ...
                <form id="releaseDecisionHistoryFilterForm" class="inline-form">
                    ...
                    <button id="downloadReleaseDecisionActionPlanBtn" type="button">Download Decision Action Plan</button>
                    <button id="downloadReleaseDecisionCheckMatrixBtn" type="button">Download Decision Checks</button>
                    <button id="downloadReleaseDecisionReviewBundleBtn" type="button">Download Decision Review Bundle</button>
                </form>
                ...
                <pre id="releaseDecisionIssuesSummaryView">Loading...</pre>
                <pre id="releaseDecisionActionPlanView">Loading...</pre>
                <pre id="releaseDecisionCheckMatrixView">Loading...</pre>
                <pre id="releaseDecisionOwnerSummaryView">Loading...</pre>
                ...
                <form id="releaseLogFilterForm" class="inline-form">
                    ...
                    <button id="downloadReleaseLogLatestCompareBtn" type="button">Download Release Compare</button>
                </form>
